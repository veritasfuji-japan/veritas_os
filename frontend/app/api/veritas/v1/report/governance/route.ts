  ...
  return {
    ...
    mappings: [
      ...
      },
      {
        ...
        limitation: "does_not_claim_automatic_intervention_success_or_enforcement",
      },
      {
        ...
        limitation: "does_not_claim_automatic_reversibility_or_enforcement_after_horizon",
      },
      {
        ...
        limitation: "does_not_claim_automatic_intervention_or_infer_actor_psychology_or_intent",
      },
      {
        ...
        limitation: "does_not_claim_automatic_bind_invalidity_or_enforcement",
      },
      {
        marker_id: "self_authorization",
        source_layer: "governance_attack_surface_registry_v0",
        representative_phase: "governance_attack_surface_review",
      ...
      },
      {
        ...
        limitation: "does_not_claim_automatic_enforcement_tamper_proof_storage_or_formal_verification",
      },
      {
        ...
        limitation: "does_not_claim_automatic_identity_proof_or_production_authentication",
      },
      {
...
function buildGovernanceEvidencePacketV0(): GovernanceEvidencePacket {
  return {
    version: "v0",
    packet_id: "pre_boundary_collapse_governance_evidence_packet_v0",
    packet_model: "deterministic_representative_reviewer_packet",
    purpose:
      "Summarize the governance trace, evidence refs, safeguards, and representative intervention categories for reviewer inspection.",
    generated_from: {
    ...
    decision_context_summary: {
      ...
      summary:
        "The bind outcome remains formally valid while governance evidence indicates decision-space narrowing and intervention viability loss occurred upstream.",
    },
    packet_sections: [
      {
    ...
    summary: {
      concise:
        "Governance Evidence Packet v0 gives reviewers a compact, deterministic summary of the governance trace, evidence refs, safeguards, and representative intervention categories.",
      operator:
        "The system should show what evidence a reviewer should inspect without claiming certification, automatic enforcement, or production security.",
    },
  };
}
...
async function resolveDemoScenarioPayload(request: Request): Promise<Record<string, unknown> | null> {
  ...
  return {
    governance_layer_snapshot: {
      ...
      governance_evidence_packet: buildGovernanceEvidencePacketV0(),
    },
  };
}
