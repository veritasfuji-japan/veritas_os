...
describe("DecisionConsolePage", () => {
  ...
  it("renders structured sections from decide response", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText("WAT Integrity Status")).toBeInTheDocument();
      expect(screen.getByText("Drift Vector Breakdown")).toBeInTheDocument();
  ...
  it("renders critical integrity state for WAT widget", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText("wat_critical")).toBeInTheDocument();
    });
  });
  ...
  it("gracefully falls back to legacy meta.wat_shadow payload", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText("wat_legacy")).toBeInTheDocument();
