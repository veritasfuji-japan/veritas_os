...
export function MissionLayout({ children }: MissionLayoutProps): JSX.Element {
  ...
  return (
    <>
      <aside aria-label="サイドバー" className="border-b border-border/80 bg-surface/95 p-6 backdrop-blur lg:row-span-full lg:border-b-0 lg:border-r">
        <a
          href="#main-content"
      ...
      <header className="min-w-0 border-b border-border/80 bg-surface/80 px-6 py-4 backdrop-blur">
      ...
      <main id="main-content" className="min-w-0 p-6" tabIndex={-1}>{children}</main>
    </>
  );
}
