...
def write_performance_evidence(json_path: Path = OUTPUT_JSON, markdown_path: Path = OUTPUT_MD, generated_at: str | None = None, sample_count: int = 30, warmup_count: int = 3, deterministic_fixture: bool = False) -> dict[str, Any]:
    evidence = generate_performance_evidence(generated_at=generated_at, sample_count=sample_count, warmup_count=warmup_count, deterministic_fixture=deterministic_fixture)
