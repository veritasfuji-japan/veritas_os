...
- include_raw_upstream_fields=True requires BOTH:
  - VERITAS_RSA_SANDBOX_ENABLE set to a truthy value.
  - VERITAS_RSA_SANDBOX_ALLOW_RAW_UPSTREAM set to a truthy value.
...
- truthy values are parsed after trim/lower normalization and accept: 1, true, yes, on.
