...
- The audit_entry includes upstream-provided fields.
- original_llm_intent and rsa_action_taken may contain sensitive content.
- Do not persist these raw fields outside tests unless routed through the TrustLog redaction/sanitization pipeline.
