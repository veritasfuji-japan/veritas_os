...
- `VERITAS_TRUSTLOG_SIGNER_BACKEND` does not resolve to `aws_kms`; `aws_kms_ed25519` is treated as `aws_kms`, while `file` and `file_ed25519` are treated as non-production file signers and fail this check
