...
- timestamp — clock skew: VERITAS receiver clock と比較して、過去または未来に strictly more than 300 seconds（5 minutes）ずれる payload は validation failure として reject しなければなりません（skew > 300 s; skew = 300 s is accepted）。Reason code: UPSTREAM_MOCK_PAYLOAD_INVALID.
