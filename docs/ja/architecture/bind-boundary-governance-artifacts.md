# Bind-Boundary Governance Artifacts（bind境界ガバナンス成果物）
...
## 英語正本
- [../../en/architecture/bind-boundary-governance-artifacts.md](../../en/architecture/bind-boundary-governance-artifacts.md)
