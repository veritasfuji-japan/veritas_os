...
def verify_evidence_bundle(
    ...
    *,
    ...
    Returns:
        ...
        - authenticity_ok: bool for manifest signature authenticity only
        - authenticity_failure: machine-readable authenticity failure reason
    """
    result: Dict[str, Any] = {
        "ok": True,
        "tampered": False,
    ...
    if manifest_signature:
        if verify_signature_fn is None:
            ...
            result["authenticity_failure"] = "signature_not_verified"
            ...
            try:
                ...
                if signature_ok:
                    ...
                    result["authenticity_failure"] = None
                else:
                    result["signature_status"] = "fail"
                    result["authenticity_failure"] = (
