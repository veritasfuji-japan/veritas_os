...
def should_fail_fast_startup(profile: Optional[str] = None) -> bool:
    ...
    When profile is provided, it is authoritative and ambient environment or
    posture flags do not override it. When profile is omitted, fail-fast is
    enabled for prod/production VERITAS_ENV, strict resolved posture, or a
