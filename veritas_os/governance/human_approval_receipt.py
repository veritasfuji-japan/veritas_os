...
def build_human_approval_state(
    ...
    *,
    ...
    state = {
        ...
        "decision_id": finalized_receipt.decision_id,
        "execution_intent_id": finalized_receipt.execution_intent_id,
        "request_ref": finalized_receipt.request_ref,
        "ai_output_ref": finalized_receipt.ai_output_ref,
        "authority_evidence_id": finalized_receipt.authority_evidence_id,
        "bind_context_hash": finalized_receipt.bind_context_hash,
...
def human_approval_state_validation_hash(state: dict[str, Any]) -> str:
    ...
    payload = {
        ...
        "ai_output_ref": state.get("ai_output_ref"),
        "authority_evidence_id": state.get("authority_evidence_id"),
        "bind_context_hash": state.get("bind_context_hash"),
