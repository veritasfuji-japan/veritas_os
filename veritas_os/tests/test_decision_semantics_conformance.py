...
def test_explicit_fuji_review_decision_preserves_public_review_gate() -> None:
    """Explicit FUJI review decisions preserve review-required public semantics."""
    ctx = PipelineContext(
        request_id="req-explicit-fuji-review-decision",
        query="conformance",
        fuji_dict={"decision_status": "needs_human_review", "status": "allow"},
        decision_status="allow",
        context={},
    )
