...
def test_should_fail_fast_startup_reads_strict_posture_alias(monkeypatch):
    """Omitted profile should fail fast when VERITAS_POSTURE is strict."""
    monkeypatch.delenv("VERITAS_ENV", raising=False)
...
def test_should_fail_fast_startup_reads_strict_env_alias(monkeypatch):
    """Omitted profile should fail fast when VERITAS_ENV is strict alias."""
