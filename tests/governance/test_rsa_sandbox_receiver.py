...
def test_default_output_redacts_upstream_fields() -> None:
...
def test_opt_in_output_includes_raw_upstream_fields() -> None:
    payload = _payload("SAFE_PROCEED")
    result = evaluate_rsa_sandbox_signal(
        payload,
        include_raw_upstream_fields=True,
    )
