...
- **Reviewer Key Provenance Walkthrough**: [`docs/en/validation/reviewer-key-provenance-walkthrough.md`](docs/en/validation/reviewer-key-provenance-walkthrough.md)
...
| `VERITAS_POLICY_RUNTIME_BUNDLE_DIR` | — | Deployment-controlled compiled policy bundle path used when runtime enforcement is mandatory |
