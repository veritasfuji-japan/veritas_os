...
- **現時点の説明境界**: 本リポジトリは、実装済みの統制境界と検証可能な証跡を示すbeta段階のシステムです。
- **注意**: 現時点で全ての副作用経路がbind-governedであると主張するものではありません。
- **本番導入前提**: 本番環境での利用には、環境ごとのハードニング、鍵管理、監査設計、運用手順の確立が必要です。
...
- **AML/KYC Beachhead（1-day PoC quickstart）**: [`docs/ja/guides/aml-kyc-poc-quickstart.md`](docs/ja/guides/aml-kyc-poc-quickstart.md)
- **AML/KYC Governance Template Contract**: [`docs/ja/guides/financial-governance-templates.md`](docs/ja/guides/financial-governance-templates.md)
- **External Audit / Evidence Bundle Readiness**: [`docs/ja/validation/external-audit-readiness.md`](docs/ja/validation/external-audit-readiness.md)
- **External Technical Proof Pack（review/pilot/DD/audit）**: [`docs/ja/validation/technical-proof-pack.md`](docs/ja/validation/technical-proof-pack.md)
- **AML/KYC Short Positioning（customer / operator / investor）**: [`docs/ja/positioning/aml-kyc-beachhead-short-positioning.md`](docs/ja/positioning/aml-kyc-beachhead-short-positioning.md)
...
- **公開ポジショニングガイド（英語正本）**: [`docs/en/positioning/public-positioning.md`](docs/en/positioning/public-positioning.md)
...
- **Required Evidence Taxonomy v0（日本語）**: [`docs/ja/governance/required-evidence-taxonomy.md`](docs/ja/governance/required-evidence-taxonomy.md)
...
開始リンク:
- [1-day PoC Quickstart](docs/ja/guides/aml-kyc-poc-quickstart.md)
